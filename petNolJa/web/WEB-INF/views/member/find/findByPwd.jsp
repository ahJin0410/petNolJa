...
<body>
    ...
    <div align="center">
        <div class="innerwrap">
            <h2>비밀번호 찾기</h2>
            <p id="script">
                비밀번호가 기억나지 않으세요? 회원님의 정보로 임시 비밀번호 발급이 가능합니다.<br>
                입력하신 정보는 임시비밀번호 발급에만 사용되며 저장되지 않습니다.
            </p><br><br><hr>
            <form action="${pageContext.servletContext.contextPath}/member/find/pwd" method="post" onsubmit="return checkInfo();">
                <table class="middleTable" style="width:65; height: 100%; padding-top: 50px;">
                    <tr>
                        <td style="width: 20%; height: 80px;"><label for="memberId">아이디</label></td>
                        <td><input type="text" name="memberId" id="memberId" placeholder="아이디를 입력해주세요." required="required"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="center" colspan="2" style="height: 80px;">
                            ...
                            <button type="submit" id="button">임시비밀번호 받기</button>
                        </td>
                    </tr>
                </table>
